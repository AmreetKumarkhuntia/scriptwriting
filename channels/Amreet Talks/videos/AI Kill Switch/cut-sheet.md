...
| 2 | `KS-SealDrop.mp4` | **0:41.0** | 10.0s | 0:51.0 | The "race" bracket: GOOGLE **vs** ANTHROPIC **vs** OPENAI cards pop on "teen company" → the giant flat **government rosette seal DROPS** over the whole bracket (impact at 0:47.9) → "ASLI PLAYER: GOVERNMENT" on "wo actually government hai" (0:48.4 ✓). |
...
| 8 | `KS-OrderVsRequest.mp4` | **4:43.5** | 9.0s | 4:52.5 | Comparison board, one clamp glyph above BOTH: ANTHROPIC card takes the red **LEGAL ORDER** stamp on "legal order tha" (4:45.4 ✓); OPENAI card gets the polite paper **"SIRF EK REQUEST"** note on the spoken line (4:47.4 ✓) + SOL·TERRA·LUNA chips; the hand tightens → **"DO COMPANIES · DO HAFTE · EK HAATH"** (4:50.6). |
...
Coverage: ~107s ≈ 29% of runtime. No 60s stretch graphics-free; never two takeovers within 12s.
