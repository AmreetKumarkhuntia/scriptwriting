...
// A strike-through "dead idea" word: it fades up, then a red bar wipes across
// it. Used for contrast beats (e.g. "LAYOFFS EVERYWHERE", "ONE CONCLUSION").
